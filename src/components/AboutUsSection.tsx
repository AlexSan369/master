      ...
      <div className="max-w-6xl pt-24 lg:pt-36 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-600 mt-6 text-base md:text-lg leading-relaxed">
            Na Master Barbearia, combinamos a tradição milenar do barbear e corte masculino com as técnicas mais modernas. Visite o nosso espaço e desfrute de um ambiente acolhedor, onde cada detalhe é pensado para o seu conforto e satisfação. Uma experiência de estilo e bem-estar que você merece.
          </p>
